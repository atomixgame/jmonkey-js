...
namespace com.jme3.texture.image {
     ...
     */
    export abstract class ImageRaster {
        /**
         ...
         */
        public static create(image? : any, slice? : any, mipMapLevel? : any, convertToLinear? : any) : any {
            if(((image != null && image instanceof com.jme3.texture.Image) || image === null) && ((typeof slice === 'number') || slice === null) && ((typeof mipMapLevel === 'number') || mipMapLevel === null) && ((typeof convertToLinear === 'boolean') || convertToLinear === null)) {
                let __args = Array.prototype.slice.call(arguments);
                return <any>(() => {
                    return new DefaultImageRaster(image, slice, mipMapLevel, convertToLinear);
                })();
            } else if(((image != null && image instanceof com.jme3.texture.Image) || image === null) && ((typeof slice === 'number') || slice === null) && mipMapLevel === undefined && convertToLinear === undefined) {
                return <any>com.jme3.texture.image.ImageRaster.create$com_jme3_texture_Image$int(image, slice);
            } else if(((image != null && image instanceof com.jme3.texture.Image) || image === null) && slice === undefined && mipMapLevel === undefined && convertToLinear === undefined) {
                return <any>com.jme3.texture.image.ImageRaster.create$com_jme3_texture_Image(image);
         ...
         * @return An ImageRaster to read / write to the image.
         */
        public static create$com_jme3_texture_Image$int(image : Image, slice : number) : ImageRaster {
            return ImageRaster.create(image, slice, 0, false);
        }
         ...
         * @return An ImageRaster to read / write to the image.
         */
        public static create$com_jme3_texture_Image(image : Image) : ImageRaster {
            if(image.getData().size() > 1) {
                throw new java.lang.IllegalStateException("Use constructor that takes slices argument to read from multislice image");
            }
            return ImageRaster.create(image, 0, 0, false);
        }
         ...
         */
        public abstract setPixel(x : number, y : number, color : ColorRGBA);
         ...
         * @throws IllegalArgumentException If x or y are outside the image dimensions.
         */
        public getPixel(x : number, y : number, store : ColorRGBA = null) : ColorRGBA;
    }
    ImageRaster["__class"] = "com.jme3.texture.image.ImageRaster";
